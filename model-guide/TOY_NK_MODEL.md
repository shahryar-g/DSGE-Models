...
This file documents the included example model in `src/dsge/models/toy_nk.py`.
...
## Matrix form used by the framework
...
Solvers then compute reduced form:
